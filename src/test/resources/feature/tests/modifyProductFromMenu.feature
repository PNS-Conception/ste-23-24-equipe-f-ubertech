Feature: Modifying Products from the menu by the Restaurant
  ...
  Scenario:Restaurant can edit a product price
    Given the restaurant owner has a product called "Couscous" with a price of 30 euros
    When he wants to edit the price of the product to 35 euros
    Then the product price is changed to 35 euros
